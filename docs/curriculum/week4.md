...
1. 從八張卡挑**兩張**你最有感的，用自己的話重寫「卡在哪」與「這門學問怎麼解」，不看教材。
2. 每張加一欄「我覺得它該放哪一堆（現在／閘門／延後），理由」。
3. 拿第 1 週的決策矩陣，**換成「團體層」的權重再算一次**，看答案有沒有變。
...
- 我重寫的兩張卡是 ___ 和 ___。
- 教授問倒我的問題：___
- 一台大約 ___ 元，最貴的部分是 ___，我沒想到。
- 目標市場我認為是 ___ 層，因為 ___；換成這一層權重，第 1 週的矩陣 ___（變／沒變）。
