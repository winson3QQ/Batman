...
| 整理助手 | 把學生自己的筆記整理成表或圖，內容不變 | 八張學門卡排成對照表 |
| 模擬器／出題者 | 給變化情境或反方立場，學生自己推演後果 | 「夜間、下雨、多一隊沒受訓的志工」會改掉哪些規格 |

每週另有一節「AI 延伸學習」，用同樣的四種角色把該週主題往外延伸（例如第 1 週讓 AI 替 Meshtastic 辯護、第 4 週讓 AI 扮採購人員）。
