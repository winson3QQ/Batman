...
flowchart LR
  subgraph M1[第一個月：看懂整個計畫]
    W1[第1週<br/>為什麼還不夠？<br/>技術選型] --> W2[第2週<br/>從畫面到規格<br/>試著開規格]
    W2 --> W3[第3週<br/>系統與元件<br/>為什麼要跨學門]
    W3 --> W4[第4週<br/>各學門要解什麼<br/>七張學門卡]
  end
...
| 2 | 從畫面到規格：試著開規格 | 規格是什麼、為什麼要有？畫面怎麼變成可以驗的句子？ | 五步開規格 | 需求工程、系統工程 | [week2.md](week2.md) |
| 3 | 系統與元件：為什麼一個科系解決不了 | 一條規格靠什麼一起做到？故障為什麼多在介面？ | 黑箱／白箱、介面清單、規格→元件連線 | 系統工程 | [week3.md](week3.md) |
| 4 | 各學門在這案子裡要解什麼 | 七個學門的人桌上各擺什麼問題？哪些現在就要解？ | 學門卡、現在／閘門／延後分堆 | 全部七個 | [week4.md](week4.md) |
...
6. **筆記是產出，不是作業。** 用 [notes-template.md](notes-template.md)，每週 10 行以內。第 8 週把 7 份筆記整理成自主學習計畫成果。
7. **第二個月的協助任務**在 [month2-tasks.md](month2-tasks.md)，每張任務卡都對應一張真實的 GitHub issue，做完可以真的變成一個 PR（作品集裡有「我對開源專案的貢獻」）。

## 使用 AI 的規矩：不是問答

每週的 AI 題都遵守一條規則：**學生先有產出，AI 才進場，而且 AI 不給答案。** AI 只扮三種角色：

| 角色 | 做什麼 | 例子 |
|---|---|---|
| 反對派／審稿人 | 挑學生做好的東西的毛病；學生決定接不接受，理由寫下來 | 攻擊決策矩陣裡最主觀的權重 |
| 利害關係人 | 扮救難隊員、驗收工程師、某系教授，只問問題 | 「這條規格要怎麼量？」「這對我在山上有什麼差？」 |
| 整理助手 | 把學生自己的筆記整理成表或圖，內容不變 | 七張學門卡排成對照表 |

- 可以用 Claude（美國 Anthropic）、ChatGPT（美國 OpenAI）、Gemini（美國 Google）等。**不要**把節點的 IP、密碼、金鑰、位置貼給任何 AI。
- AI 講的內容要寫進筆記時，標 `AI 說：`，自己驗證過的才拿掉這個標籤。
